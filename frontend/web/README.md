...
들어갑니다. 새 비밀번호는 8~72자이면서 UTF-8 72바이트 이하인지 검사하고, 가입·변경·재설정과 모바일 가입에 같은 공통 검증을 사용합니다. 한글은 보통 한 글자에 3바이트입니다. 이미 가입된 이메일(409)·시도 제한(429)을 구분해 안내합니다. 약관 동의는 가입 버튼
